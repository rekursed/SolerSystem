...
using namespace std;
#define SunSize 0.2
#define MarcurySize 0.02
#define VenusSize 0.036
#define EarthSize 0.04
#define MarsSize 0.043
#define JupiterSize 0.097
#define SaturnSize 0.078
#define UranusSize 0.05
#define NeptuneSize 0.045
...
void PlacePlanet(Planet x)
{
	...
	glPushMatrix();
		...
		//glutSolidSphere(x.Size,20,20);
		//glColor3f(x.Clx-0.09,x.Cly-0.09,x.Clz-0.09);
		//glutWireSphere(x.Size+0.005,20,20);
		//Draw earth
